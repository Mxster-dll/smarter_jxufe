...
import 'package:smarter_jxufe/old/ims/data/repositories/ims/Course.dart';
import 'package:smarter_jxufe/old/ims/data/repositories/ims/AcademicTime.dart';
import 'package:smarter_jxufe/old/ims/data/repositories/ims/Grades.dart';
...
class GradeService {
  ...
  Future<GradeTable?> getGrade() async {
    ...
    try {
      ...
      //   CourseGrade lineToCourse(List<String> line) {
      //     String info(String key) => line[idx[key]!].trim();
      //     return CourseGrade(
      //         await data.findFirstCourse(
      //             '' : ,
      //         ),
      //         double.parse(info('成绩')),
      //         Semester(),
      //         credit:double.parse(info('获得学分')),
      //         gradePoint:double.parse(info('绩点')),
      //         gradePointCredit:double.parse(info('学分绩点')),
      //         attempt:CourseAttempt.parse(info('考核方式')),
      //         remark: info('备注'),
      //     );
      //   }
