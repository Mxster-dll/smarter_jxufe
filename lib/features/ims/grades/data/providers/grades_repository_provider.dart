...
import 'package:smarter_jxufe/features/ims/grades/data/providers/grades_local_datasource_provider.dart';
...
Future<GradesRepository> gradesRepository(GradesRepositoryRef ref) async {
  ...
  final localDataSource = await ref.watch(gradesLocalDataSourceProvider.future);
